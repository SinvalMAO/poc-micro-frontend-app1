...
const { REACT_APP_MICROFRONTEND_HOST: microfrontendHost } = process.env;
const { REACT_APP_MICROEXAMPLE_HOST: microExampleHost } = process.env;
...
const MicroExample = ({ history }) => (
  <MicroFrontend
    history={history}
    host={microExampleHost}
    name="microexample"
  />
);
  ...
  return (
    <BrowserRouter>
      ...
      <ul>
        ...
        <li>
          <NavLink to="/createreactapp">
            Micro CreateReactApp
          </NavLink>
        </li>
        <li>
          <NavLink to="/microfrontend">
            Micro MyComponent
          </NavLink>
        </li>
        <li>
          <NavLink to="/microexample">
            Micro Example
          </NavLink>
        </li>
      </ul>
      ...
      <Switch>
        ...
        <Route path="/microfrontend" render={() => <MyComponent />} />
        <Route path="/microexample" render={() => <MicroExample />} />
      </Switch>
    </BrowserRouter>
  );
};
